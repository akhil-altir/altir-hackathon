    ...
    >
      <ParticipantStage>
        <div className="mb-2 flex flex-wrap items-center gap-3">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-sm border border-amber-400/35 bg-amber-400/10 px-2 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-amber-200">
